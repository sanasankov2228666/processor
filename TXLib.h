...
//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2025-08-17 06:00:49 +0400 $]
...
//!
//!          $Version: 00173a, Revision: 174 $
//!          $Copyright: (C) Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru> $
//!          $Date: 2025-08-17 06:00:49 +0400 $
//!
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 174, 2025-08-17 06:00:49 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 174, 2025-08-17 06:00:49 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 174, 2025-08-17 06:00:49 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
$   va_start (args, message);
$   txOutputDebugPrintf ("txPause(): message, args");  // !!! 0xC0000005 reading [-1]
$   va_end (args);
...
$       _txWaitFor (GetForegroundWindow() == wnd, 10*_TX_TIMEOUT);
...
const char* txGetModuleFileName (bool fileNameOnly /*= true*/)
    ...
    if (!*name)
        {
        if (!GetModuleFileName (NULL, name, sizeof (name) - 1)) strncpy_s (name, sizeof (name), "~TXApp", 6);
